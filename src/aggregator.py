...
class LogAggregator:
    ...
    def get_source_summary_formatted(self, limit: int = 5) -> str:
        """Get formatted source summary string.

        Args:
            limit: Maximum number of sources.

        Returns:
            Formatted source summary string.
        """
        return self.get_source_summary(limit)

    def get_time_span_formatted_alt(self) -> str:
        """Get formatted time span string (alternative).

        Returns:
            Formatted time span string.
        """
        return self.get_time_span_formatted()
    ...
    def get_summary_string_alt(self) -> str:
        """Get summary string (alternative).
    ...
    def get_source_counts_formatted_alt(self) -> str:
        """Get formatted source counts string (alternative).
    ...
    def get_duration_formatted_alt(self) -> str:
        """Get formatted duration string (alternative).
    ...
    def get_busiest_hours_formatted_alt(self, limit: int = 5) -> str:
        """Get formatted busiest hours string (alternative).
    ...
    def get_top_sources_formatted_alt(self, limit: int = 5) -> str:
        """Get formatted top sources string (alternative).
    ...
    def get_source_distribution_formatted_alt(self) -> str:
        """Get formatted source distribution string (alternative).
    ...
    def get_most_common_source_formatted_alt(self) -> str:
        """Get formatted most common source string (alternative).
    ...
    def get_least_common_source_formatted_alt(self) -> str:
        """Get formatted least common source string (alternative).
    ...
    def get_error_rate_formatted_alt(self) -> str:
        """Get formatted error rate string (alternative).
    ...
    def get_warning_rate_formatted_alt(self) -> str:
        """Get formatted warning rate string (alternative).
    ...
    def get_info_rate_formatted_alt(self) -> str:
        """Get formatted info rate string (alternative).
    ...
    def get_debug_rate_formatted_alt(self) -> str:
        """Get formatted debug rate string (alternative).
    ...
    def get_critical_rate_formatted_alt(self) -> str:
        """Get formatted critical rate string (alternative).
    ...
    def get_non_error_rate_formatted_alt(self) -> str:
        """Get formatted non-error rate string (alternative).
